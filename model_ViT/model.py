...
class PatchEmbed3D(nn.Module):
    def __init__(self, img_size=224, patch_size=16, in_c=1, embed_dim=768):
...
class VisionTransformer3D(nn.Module):
    def __init__(self, img_size=224, patch_size=16, in_c=1, embed_dim=768, depth=12, num_heads=12, mlp_ratio=4., qkv_bias=False, qk_scale=None, drop=0., attn_drop=0.):
...
if __name__ == "__main__":
    ...
    model = VisionTransformer3D(img_size=224, patch_size=16, in_c=2, embed_dim=1536, depth=12, num_heads=12, mlp_ratio=4., qkv_bias=False, qk_scale=None, drop=0., attn_drop=0.)
    print(model)