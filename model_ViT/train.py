...
model = VisionTransformer3D(img_size=64, patch_size=16, in_c=2, embed_dim=1536, depth=12, num_heads=12, mlp_ratio=4., qkv_bias=False, qk_scale=None, drop=0., attn_drop=0.).to(device)
...
for epoch in range(num_epochs):
    ...
    if (epoch+1) % 5 == 0 or epoch == 0:
        ...
        torch.save(checkpoint, f"ViT_lessSize_checkpoint_epoch{epoch+1}.pth")
        print(f"Model saved as model_ViT_lessSize_randomCrop_Lploss_epoch{epoch+1}.pth")
